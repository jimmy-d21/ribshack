// Request Center Page Data
// This file contains all data needed for the Request Center page

export const requestCenterData = {
  // Statistics for request overview
  stats: {
    pending: 3,
    approved: 1,
    declined: 1,
  ...
  // All inventory and restock requests from branches
  requests: [
    {
      id: 1,
