// Branch Management Page Data
// This file contains all data needed for the Branch Management page

export const branchManagementData = {
  // Available cities for branch locations
  cities: [
    // Visayas
