    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              ₱{currentMonth.grossSales.toLocaleString()}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500 mt-1">January - June 2026</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              ₱{totalVATYTD.toLocaleString()}
            </div>
            <p className="text-xs text-gray-500 mt-1">12% VAT on sales</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-purple-600 mt-1">28.5% profit margin</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Detailed breakdown of revenue, VAT, expenses, and profit
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                12% VAT collection and filing status
              </CardDescription>
            </div>
            <Button
              ...
              <tbody>
                {vatReports.map((report, index) => (
                  <tr key={index} className="border-b hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4 text-right">
                      ₱{report.grossSales.toLocaleString()}
                    </td>
                    <td className="py-3 px-4 text-right text-orange-600">
                      ₱{report.vatCollected.toLocaleString()}
                    </td>
                    <td className="py-3 px-4 text-right text-red-600">
                      ₱{report.vatPayable.toLocaleString()}
                    </td>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Download reports for accounting and tax compliance
          </CardDescription>
        </CardHeader>
        <CardContent>
